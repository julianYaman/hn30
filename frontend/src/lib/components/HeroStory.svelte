...
<div class="bg-[var(--color-background-card)] rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 overflow-hidden">
  ...
  <div class="px-6 pb-6">
    ...
    {:else if isLoadingSummary}
      <div class="text-base text-justify p-4 bg-[var(--color-background-dark-sections)] rounded-md animate-pulse">Loading summary...</div>
    {:else if isSummaryVisible && error}
      <div class="text-base text-justify p-4 bg-red-100 text-red-700 rounded-md">{error}</div>
    {/if}
  </div>
